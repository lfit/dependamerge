...
"""
The periodic 'still waiting' status display.

Two renderings of the same information: a Rich live table when the
console supports it, and a plain-text fallback when it does not.
"""
...
class _StatusTickerMixin(_MergeManagerBase):
    """Rendering the periodic waiting-PR status line."""
