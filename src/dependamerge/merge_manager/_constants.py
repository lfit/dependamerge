...
"""
Timing and presentation constants for the async merge manager.

Every polling loop in the package derives its iteration count from
these values, so a timeout is consistent and adjustable from one
place or via the ``--merge-timeout`` flag.
"""
