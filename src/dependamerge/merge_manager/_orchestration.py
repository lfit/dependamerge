...
"""
Top-level fan-out over a batch of pull requests.

The public entry point, the flat and repository-striped scheduling
strategies it dispatches to, and the collection of their results.
"""
