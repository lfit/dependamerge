...
"""
Result types for a single merge attempt.

The status enumeration, the per-pull-request result record, and the
two payload predicates that classify a GitHub merge response.
"""
